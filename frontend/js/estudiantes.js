...
function renderEstudiantes() {
    ...
    estudiantesPaginados.forEach((est) => {
        ...
        <td data-label="Fecha Nac." class="px-6 py-4 text-slate-600">${fechaNac}</td>   <!-- NUEVA CELDA -->
    ...
    <div class="flex justify-end items-center gap-2">
        <button onclick="editarEstudiante(${est.id_estudiante})"
            class="text-institucional-600 hover:text-institucional-900"
            title="Editar">
        ...
        <button onclick="confirmarEliminar(${est.id_estudiante})"
